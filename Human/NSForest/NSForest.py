...
adata = ad.read_h5ad(os.path.join(work_dir, f"Human_basalganglia_HMBA_AIT19-5_anno_latest.h5ad"))
...
for anno in ["cluster_id"]:
    ...
    output_path = f"/allen/programs/celltypes/workgroups/rnaseqanalysis/EvoGen/BasalGanglia/NSForest/{species}/{anno}/"
