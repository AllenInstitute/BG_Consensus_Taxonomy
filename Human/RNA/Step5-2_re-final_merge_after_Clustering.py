...
adata = sc.read_h5ad(os.path.join(work_dir, f"{species}_basalganglia_{pipeline}_HMBA_AIT19-4_anno_filtered_scVI.h5ad"))
...
adata.obs['cluster_old'] = adata.obs['cluster'].copy()
adata.obs["cluster"] = ""
