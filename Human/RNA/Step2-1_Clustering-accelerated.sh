...
# 0. please refer to https://github.com/dyuan1111/hicatMPI/tree/main 
...
adata_dir="/allen/programs/celltypes/workgroups/rnaseqanalysis/HMBA/Aim1_Atlases/Human/BasalGanglia/Human_basalganglia_AIBS_HMBA_LeidenCluster_filtered_scVI.h5ad" # norm or counts in X is fine.
