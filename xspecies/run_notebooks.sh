...
#SBATCH --array=1# Create an array job for each line in notebooks.txt
#SBATCH --gres=gpu:1 --constraint="a100|v100" #|v100
#SBATCH --mem 64gb
#SBATCH --ntasks 1
...
NOTEBOOK=$(sed -n "${SLURM_ARRAY_TASK_ID}p" ~/Matthew/code/HMBA_Genomics/BasalGanglia/xspecies/notebooks.txt)
