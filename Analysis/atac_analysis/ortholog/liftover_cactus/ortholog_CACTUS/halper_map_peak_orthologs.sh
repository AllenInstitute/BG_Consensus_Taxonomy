...
CACTUSFILE=/allen/programs/celltypes/workgroups/rnaseqanalysis/EvoGen/Team/Matthew/genome/hal/zoonomia/447-mammalian-2022v1_replaceAIBSexceptHuman.hal
OVERWRITE='FALSE'; NAME=''; SNP=''; 
# HALPER defaults
MIN_LEN=50; PROTECT_DIST=10; MAX_FRAC=2; ## 2*peak_length
...
CACTUS_DIR=/allen/programs/celltypes/workgroups/rnaseqanalysis/EvoGen/Team/Matthew/genome/hal/zoonomia/
...
{    
    ...
    OUTFILE2=${TMP_HAL_DIR}/${NAME}.${SOURCE}To${TARGET}.HALPER_${MAX_LEN}.narrowPeak
