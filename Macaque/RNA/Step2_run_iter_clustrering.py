...
adata = ad.read_h5ad(os.path.join(work_dir, f"{species}_basalganglia_HMBA_cluster_qc.h5ad"))
...
adata.write_h5ad(os.path.join(work_dir, f"{species}_basalganglia_HMBA_AIT11-8.h5ad")) 
adata.write_h5ad(os.path.join(cxg_dir, f"{species}_basalganglia_HMBA_AIT11-8.h5ad")) 