...
anno_table = pd.read_csv(pjoin(out_path, 'anno_table.csv'))

## Process the sample
print(sample)
os.makedirs(out_path, exist_ok=True)
h5_out = pjoin(out_path, sample['ar_id'] + '.h5ad')
...
## Annotate
for anno in ['Neighborhood', 'Class', 'Subclass', 'Group','cluster_id']:
...
snap.pp.filter_cells(atac_h5ad, min_tsse=5, min_counts=1000)
