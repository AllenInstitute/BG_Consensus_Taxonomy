...
## ------------------------------------------------------
adata = read_h5ad("Human_HMBA_basalganglia_AIT.h5ad");
...
adata$uns$title = "Human_HMBA_basalganglia_consensus_AIT"
...
## Finalize AIT
adata$write_h5ad("Human_HMBA_basalganglia_AIT_pre-print.h5ad")