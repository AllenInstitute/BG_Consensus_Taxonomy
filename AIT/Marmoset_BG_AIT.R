...
## ------------------------------------------------------
adata = read_h5ad("Marmoset_HMBA_basalganglia_AIT.h5ad");
...
adata$uns$title = "Marmoset_HMBA_basalganglia_consensus_AIT"
...
## Finalize AIT
adata$write_h5ad("Marmoset_HMBA_basalganglia_AIT_pre-print.h5ad")